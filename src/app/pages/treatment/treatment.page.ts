...
// import { IonContent, IonHeader,  IonTitle, IonToolbar,IonChip, IonLabel,IonItem,IonList,
...
//   standalone: true,
//   providers:[HttpClient,ContentService,UserService,HttpService,UserInteractionService, AuthService],
//   imports: [IonSpinner,IonChip,IonLabel, IonContent, IonItem,IonIcon,
//    IonList, IonHeader, IonTitle, HttpClientModule,
...
import { CommonModule } from '@angular/common';
import { FormsModule } from '@angular/forms';
import { IonContent,IonHeader, IonTitle,IonList, IonItem, IonLabel, IonIcon,
 IonChip, IonButton, IonSpinner, IonToolbar } from '@ionic/angular/standalone';
import { UserInteractionService } from 'src/app/services/user-interaction.service';
import { AuthService } from 'src/app/services/auth.service';
...
export class TreatmentPage implements OnInit,OnDestroy,ViewWillLeave {
