...
@Component({
  ...
  templateUrl: './living-with-hiv.page.html',
  styleUrls: ['./living-with-hiv.page.scss'],  // ✅ Correct filename
  standalone: true,
...
export class LivingWithHIVPage implements OnInit,OnDestroy,ViewWillLeave {
