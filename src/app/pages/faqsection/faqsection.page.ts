...
@Component({
  ...
  templateUrl: './faqsection.page.html',
  styleUrls: ['./faqsection.page.scss'],
  standalone: true,
  providers:[HttpClient, ContentService, UserService, HttpService, AuthService, UserInteractionService],
    imports: [IonContent, IonHeader, IonTitle, IonSpinner, HttpClientModule, IonList, IonItem,
      IonLabel, IonToolbar, CommonModule, FormsModule]
})
export class FAQSectionPage implements OnInit,OnDestroy,ViewWillLeave {
