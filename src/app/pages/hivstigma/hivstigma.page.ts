...
@Component({
  selector: 'app-hivstigma',
  templateUrl: './hivstigma.page.html',
  styleUrls: ['./hivstigma.page.scss'],
  standalone: true,
...
export class HIVStigmaPage implements OnInit,OnDestroy,ViewWillLeave {
