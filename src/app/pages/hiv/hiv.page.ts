...
import { IonContent, IonHeader, IonSpinner, IonChip, IonLabel,
 IonList,IonIcon,IonItem, IonNote, IonTitle, IonToolbar } from '@ionic/angular/standalone';
...
@Component({
  selector: 'app-hiv',
  templateUrl: './hiv.page.html',
  styleUrls: ['./hiv.page.scss'],
  standalone: true,
  providers:[ContentService,UserService, AuthService,UserInteractionService,],
    imports: [IonContent, IonHeader, IonTitle, IonSpinner, HttpClientModule,
     IonChip,IonLabel,IonList,IonIcon,IonItem,IonNote, IonToolbar, CommonModule, FormsModule]
})
export class HIVPage implements  OnInit, OnDestroy,ViewWillLeave{
