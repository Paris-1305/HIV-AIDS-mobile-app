...
@Component({
  selector: 'app-ending-hiv-stigma',
  templateUrl: './ending-hiv-stigma.page.html',
  styleUrls: ['./ending-hiv-stigma.page.scss'],
  standalone: true,
...
export class EndingHivStigmaPage implements OnInit {
